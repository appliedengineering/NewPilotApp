...
public enum SocketType
{
     ...
     * </table>
     */
    CLIENT(external.zmq.ZMQ.ZMQ_CLIENT),
     ...
     * </table>
     */
    SERVER(external.zmq.ZMQ.ZMQ_SERVER),
     ...
     */
    @Draft
    RADIO(external.zmq.ZMQ.ZMQ_RADIO),
     ...
     */
    @Draft
    DISH(external.zmq.ZMQ.ZMQ_DISH),
     ...
     */
    @Draft
    CHANNEL(external.zmq.ZMQ.ZMQ_CHANNEL),
     ...
     */
    @Draft
    PEER(external.zmq.ZMQ.ZMQ_PEER),
     ...
     */
    @Draft
    SCATTER(external.zmq.ZMQ.ZMQ_SCATTER),
     ...
     */
    @Draft
    GATHER(external.zmq.ZMQ.ZMQ_GATHER);
