...
public final class ZTimer
{
    ...
    {
        private final external.org.zeromq.timer.ZTimer.Timer delegate;

        Timer(external.org.zeromq.timer.ZTimer.Timer delegate)
        {
     ...
     */
    @Deprecated
    public interface Handler extends external.org.zeromq.timer.TimerHandler
    {
    }

    private final external.org.zeromq.timer.ZTimer timer = new external.org.zeromq.timer.ZTimer();
