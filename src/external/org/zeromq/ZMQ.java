...
import external.org.zeromq.proto.ZPicture;
import external.zmq.Ctx;
import external.zmq.Options;
import external.zmq.SocketBase;
import external.zmq.ZError;
import external.zmq.ZError.CtxTerminatedException;
import external.zmq.io.coder.IDecoder;
import external.zmq.io.coder.IEncoder;
import external.zmq.io.mechanism.Mechanisms;
import external.zmq.io.net.SelectorProviderChooser;
import external.zmq.msg.MsgAllocator;
import external.zmq.util.Draft;
import external.zmq.util.Z85;
...
public class ZMQ
{
     ...
     */
    public static final int SNDMORE = external.zmq.ZMQ.ZMQ_SNDMORE;

    // Values for flags in Socket's send and recv functions.
    /**
     * Socket flag to indicate a nonblocking send or recv mode.
     */
    public static final int DONTWAIT = external.zmq.ZMQ.ZMQ_DONTWAIT;
    public static final int NOBLOCK  = external.zmq.ZMQ.ZMQ_DONTWAIT;

    // Socket types, used when creating a Socket. Note that all of the int types here is
    // deprecated, use SocketType instead

    @Deprecated
    public static final int PAIR = external.zmq.ZMQ.ZMQ_PAIR;

    @Deprecated
    public static final int PUB = external.zmq.ZMQ.ZMQ_PUB;
    @Deprecated
    public static final int SUB = external.zmq.ZMQ.ZMQ_SUB;

    @Deprecated
    public static final int REQ = external.zmq.ZMQ.ZMQ_REQ;

    @Deprecated
    public static final int REP = external.zmq.ZMQ.ZMQ_REP;

    @Deprecated
    public static final int DEALER = external.zmq.ZMQ.ZMQ_DEALER;
    /**
    ...
    @Deprecated
    public static final int ROUTER = external.zmq.ZMQ.ZMQ_ROUTER;
    /**
    ...
    @Deprecated
    public static final int PULL = external.zmq.ZMQ.ZMQ_PULL;

    @Deprecated
    public static final int PUSH = external.zmq.ZMQ.ZMQ_PUSH;

    @Deprecated
    public static final int XPUB = external.zmq.ZMQ.ZMQ_XPUB;

    @Deprecated
    public static final int XSUB = external.zmq.ZMQ.ZMQ_XSUB;

    @Deprecated
    public static final int STREAM     = external.zmq.ZMQ.ZMQ_STREAM;
    /**
     * Flag to specify a STREAMER device.
     */
    @Deprecated
    public static final int STREAMER   = external.zmq.ZMQ.ZMQ_STREAMER;
    /**
     * Flag to specify a FORWARDER device.
     */
    @Deprecated
    public static final int FORWARDER  = external.zmq.ZMQ.ZMQ_FORWARDER;
    /**
     * Flag to specify a QUEUE device.
     */
    @Deprecated
    public static final int QUEUE      = external.zmq.ZMQ.ZMQ_QUEUE;
    /**
     ...
     */
    public static final int EVENT_CONNECTED          = external.zmq.ZMQ.ZMQ_EVENT_CONNECTED;
    /**
     ...
     * no meaning.
     */
    public static final int EVENT_CONNECT_DELAYED    = external.zmq.ZMQ.ZMQ_EVENT_CONNECT_DELAYED;
    /**
     ...
     */
    public static final int EVENT_CONNECT_RETRIED    = external.zmq.ZMQ.ZMQ_EVENT_CONNECT_RETRIED;
    /**
     ...
     */
    public static final int EVENT_LISTENING          = external.zmq.ZMQ.ZMQ_EVENT_LISTENING;
    /**
     ...
     */
    public static final int EVENT_BIND_FAILED        = external.zmq.ZMQ.ZMQ_EVENT_BIND_FAILED;
    /**
     ...
     * the accepted socket.
     */
    public static final int EVENT_ACCEPTED           = external.zmq.ZMQ.ZMQ_EVENT_ACCEPTED;
    /**
     ...
     */
    public static final int EVENT_ACCEPT_FAILED      = external.zmq.ZMQ.ZMQ_EVENT_ACCEPT_FAILED;
    /**
     ...
     */
    public static final int EVENT_CLOSED             = external.zmq.ZMQ.ZMQ_EVENT_CLOSED;
    /**
     ...
     */
    public static final int EVENT_CLOSE_FAILED       = external.zmq.ZMQ.ZMQ_EVENT_CLOSE_FAILED;
    /**
     ...
     * the socket.
     */
    public static final int EVENT_DISCONNECTED       = external.zmq.ZMQ.ZMQ_EVENT_DISCONNECTED;
    /**
     * EVENT_MONITOR_STOPPED: monitor has been stopped.
     * The EVENT_MONITOR_STOPPED event triggers when the monitor for a socket is
     * stopped.
     */
    public static final int EVENT_MONITOR_STOPPED    = external.zmq.ZMQ.ZMQ_EVENT_MONITOR_STOPPED;
    /**
     ...
     */
    public static final int EVENT_HANDSHAKE_PROTOCOL = external.zmq.ZMQ.ZMQ_EVENT_HANDSHAKE_PROTOCOL;
    /**
     * EVENT_ALL: all events known.
     * The EVENT_ALL constant can be used to set up a monitor for all known events.
     */
    public static final int EVENT_ALL                = external.zmq.ZMQ.ZMQ_EVENT_ALL;

    /**
     * Unspecified system errors during handshake. Event value is an errno.
     */
    public static final int HANDSHAKE_FAILED_NO_DETAIL   = external.zmq.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL;

    /**
     * Handshake complete successfully with successful authentication (if
     *  enabled). Event value is unused.
     */
    public static final int HANDSHAKE_SUCCEEDED      = external.zmq.ZMQ.ZMQ_EVENT_HANDSHAKE_SUCCEEDED;

    /**
     *   Protocol errors between ZMTP peers or between server and ZAP handler.
     *  Event value is one of ZMQ_PROTOCOL_ERROR_*
     */
    public static final int HANDSHAKE_FAILED_PROTOCOL = external.zmq.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL;
    /**
     *   Failed authentication requests. Event value is the numeric ZAP status
     *  code, i.e. 300, 400 or 500.
     */
    public static final int HANDSHAKE_FAILED_AUTH     = external.zmq.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_AUTH;

    public static final byte[] MESSAGE_SEPARATOR = external.zmq.ZMQ.MESSAGE_SEPARATOR;

    public static final byte[] SUBSCRIPTION_ALL = external.zmq.ZMQ.SUBSCRIPTION_ALL;

    public static final byte[] PROXY_PAUSE     = external.zmq.ZMQ.PROXY_PAUSE;
    public static final byte[] PROXY_RESUME    = external.zmq.ZMQ.PROXY_RESUME;
    public static final byte[] PROXY_TERMINATE = external.zmq.ZMQ.PROXY_TERMINATE;

    public static final Charset CHARSET = external.zmq.ZMQ.CHARSET;
    ...
    {
        return external.zmq.ZMQ.proxy(frontend.base, backend.base, null);
    }
    ...
    {
        return external.zmq.ZMQ.proxy(frontend.base, backend.base, capture != null ? capture.base : null);
    }

    public static boolean proxy(Socket frontend, Socket backend, Socket capture, Socket control)
    {
        return external.zmq.ZMQ.proxy(
                             frontend.base,
                             backend.base,
    ...
    {
        external.zmq.poll.PollItem[] pollItems = new external.zmq.poll.PollItem[count];
        for (int i = 0; i < count; i++) {
            pollItems[i] = items[i].base;
        }

        return external.zmq.ZMQ.poll(selector, pollItems, count, timeout);
    }
    ...
    {
        return external.zmq.ZMQ.ZMQ_VERSION_MAJOR;
    }
    ...
    {
        return external.zmq.ZMQ.ZMQ_VERSION_MINOR;
    }
    ...
    {
        return external.zmq.ZMQ.ZMQ_VERSION_PATCH;
    }
    ...
    {
        return external.zmq.ZMQ.makeVersion(external.zmq.ZMQ.ZMQ_VERSION_MAJOR, external.zmq.ZMQ.ZMQ_VERSION_MINOR, external.zmq.ZMQ.ZMQ_VERSION_PATCH);
    }
    ...
    {
        return external.zmq.ZMQ.makeVersion(major, minor, patch);
    }
    ...
    {
        return "" + external.zmq.ZMQ.ZMQ_VERSION_MAJOR + "." + external.zmq.ZMQ.ZMQ_VERSION_MINOR + "." + external.zmq.ZMQ.ZMQ_VERSION_PATCH;
    }

    public static void msleep(long millis)
    {
        external.zmq.ZMQ.msleep(millis);
    }

    public static void sleep(long seconds)
    {
        external.zmq.ZMQ.sleep(seconds);
    }

    public static void sleep(long amount, TimeUnit unit)
    {
        external.zmq.ZMQ.sleep(amount, unit);
    }
    ...
    public static class Context implements Closeable
    {
        ...
        {
            ctx = external.zmq.ZMQ.init(ioThreads);
        }
        ...
        {
            return ctx.get(external.zmq.ZMQ.ZMQ_IO_THREADS);
        }
        ...
        {
            return ctx.set(external.zmq.ZMQ.ZMQ_IO_THREADS, ioThreads);
        }
        ...
        {
            return ctx.get(external.zmq.ZMQ.ZMQ_MAX_SOCKETS);
        }
        ...
        {
            return ctx.set(external.zmq.ZMQ.ZMQ_MAX_SOCKETS, maxSockets);
        }
        ...
        {
            return ctx.get(external.zmq.ZMQ.ZMQ_BLOCKY) != 0;
        }

        public boolean setBlocky(boolean block)
        {
            return ctx.set(external.zmq.ZMQ.ZMQ_BLOCKY, block ? 1 : 0);
        }

        public boolean isIPv6()
        {
            return ctx.get(external.zmq.ZMQ.ZMQ_IPV6) != 0;
        }
        ...
        {
            return ctx.set(external.zmq.ZMQ.ZMQ_IPV6, ipv6 ? 1 : 0);
        }

        /**
         * Set the handler invoked when a {@link external.zmq.poll.Poller} abruptly terminates due to an uncaught exception.<p>
        ...
        /**
         * @return The handler invoked when a {@link external.zmq.poll.Poller} abruptly terminates due to an uncaught exception.
         */
    ...
    public static class Socket implements Closeable
    {
        ...
        public int getType()
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_TYPE);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_LINGER);
        }
        ...
        {
            return base.setSocketOpt(external.zmq.ZMQ.ZMQ_LINGER, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_RECONNECT_IVL);
        }
        ...
        {
            return base.setSocketOpt(external.zmq.ZMQ.ZMQ_RECONNECT_IVL, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_BACKLOG);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_BACKLOG, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_HANDSHAKE_IVL);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_HEARTBEAT_IVL);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_HEARTBEAT_TIMEOUT);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_HEARTBEAT_TTL);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(external.zmq.ZMQ.ZMQ_HEARTBEAT_CONTEXT);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_HANDSHAKE_IVL, maxHandshakeIvl);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_HEARTBEAT_IVL, heartbeatIvl);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_HEARTBEAT_TIMEOUT, heartbeatTimeout);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_HEARTBEAT_TTL, heartbeatTtl);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_HEARTBEAT_CONTEXT, pingContext);
        }
        ...
        public int getTos()
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_TOS);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_TOS, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_RECONNECT_IVL_MAX);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_RECONNECT_IVL_MAX, value);
        }
        ...
        {
            return (Long) base.getSocketOptx(external.zmq.ZMQ.ZMQ_MAXMSGSIZE);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_MAXMSGSIZE, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_SNDHWM);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_SNDHWM, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_RCVHWM);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_RCVHWM, value);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_CONFLATE, conflate);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_CONFLATE) != 0;
        }
        ...
        {
            return (Long) base.getSocketOptx(external.zmq.ZMQ.ZMQ_AFFINITY);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_AFFINITY, value);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(external.zmq.ZMQ.ZMQ_IDENTITY);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_IDENTITY, identity);
        }
        ...
        public long getRate()
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_RATE);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_RECOVERY_IVL);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_REQ_CORRELATE, correlate);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_REQ_RELAXED, relaxed);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_MULTICAST_HOPS);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_RCVTIMEO);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_RCVTIMEO, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_SNDTIMEO);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_SNDTIMEO, value);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_CNT, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_CNT);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_INTVL, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_INTVL);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_IDLE, Long.valueOf(value).intValue());
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_TCP_KEEPALIVE_IDLE);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_SNDBUF);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_SNDBUF, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_RCVBUF);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_RCVBUF, value);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_RCVMORE) == 1;
        }
        ...
        {
            return (SelectableChannel) base.getSocketOptx(external.zmq.ZMQ.ZMQ_FD);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_EVENTS);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_SUBSCRIBE, topic);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_UNSUBSCRIBE, topic);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_ENCODER, cls);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_DECODER, cls);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_MSG_ALLOCATION_HEAP_THRESHOLD, threshold);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_MSG_ALLOCATION_HEAP_THRESHOLD);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_MSG_ALLOCATOR, allocator);
        }
        ...
        {
            return base.setSocketOpt(external.zmq.ZMQ.ZMQ_SELECTOR_PROVIDERCHOOSER, chooser);
        }
        ...
        {
            return (SelectorProviderChooser) base.getSocketOptx(external.zmq.ZMQ.ZMQ_SELECTOR_PROVIDERCHOOSER);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_CONNECT_RID, rid);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_ROUTER_RAW, raw);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_PROBE_ROUTER, probe);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_ROUTER_MANDATORY, mandatory);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_ROUTER_HANDOVER, handover);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_XPUB_VERBOSE, verbose);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_XPUB_NODROP, noDrop);
        }

        public boolean setXpubManual(boolean manual)
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_XPUB_MANUAL, manual);
        }

        public boolean setXpubVerboser(boolean verboser)
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_XPUB_VERBOSER, verboser);
        }
        ...
        public boolean isIPv6()
        {
            return (Boolean) base.getSocketOptx(external.zmq.ZMQ.ZMQ_IPV6);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_IPV6, v6);
        }
        ...
        {
            return base.getSocketOpt(external.zmq.ZMQ.ZMQ_TCP_KEEPALIVE);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_TCP_KEEPALIVE, optVal);
        }
        ...
        {
            return (boolean) base.getSocketOptx(external.zmq.ZMQ.ZMQ_IMMEDIATE);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_IMMEDIATE, value);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_SOCKS_PROXY, proxy);
        }
        ...
        {
            return (String) base.getSocketOptx(external.zmq.ZMQ.ZMQ_SOCKS_PROXY);
        }
        ...
        {
            return (String) base.getSocketOptx(external.zmq.ZMQ.ZMQ_LAST_ENDPOINT);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_ZAP_DOMAIN, domain);
        }
        ...
        {
            return (String) base.getSocketOptx(external.zmq.ZMQ.ZMQ_ZAP_DOMAIN);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_PLAIN_SERVER, server);
        }
        ...
        {
            return (Boolean) base.getSocketOptx(external.zmq.ZMQ.ZMQ_PLAIN_SERVER);
        }
        ...
        {
            return base.setSocketOpt(external.zmq.ZMQ.ZMQ_PLAIN_USERNAME, username);
        }
        ...
        {
            return base.setSocketOpt(external.zmq.ZMQ.ZMQ_PLAIN_PASSWORD, password);
        }
        ...
        {
            return (String) base.getSocketOptx(external.zmq.ZMQ.ZMQ_PLAIN_USERNAME);
        }
        ...
        {
            return (String) base.getSocketOptx(external.zmq.ZMQ.ZMQ_PLAIN_PASSWORD);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_CURVE_SERVER, server);
        }
        ...
        {
            return (boolean) base.getSocketOptx(external.zmq.ZMQ.ZMQ_CURVE_SERVER);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_CURVE_PUBLICKEY, key);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_CURVE_SERVERKEY, key);
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_CURVE_SECRETKEY, key);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(external.zmq.ZMQ.ZMQ_CURVE_PUBLICKEY);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(external.zmq.ZMQ.ZMQ_CURVE_SERVERKEY);
        }
        ...
        {
            return (byte[]) base.getSocketOptx(external.zmq.ZMQ.ZMQ_CURVE_SECRETKEY);
        }
        ...
        {
            return Mechanism.find((Mechanisms) base.getSocketOptx(external.zmq.ZMQ.ZMQ_MECHANISM));
        }
        ...
        {
            return setSocketOpt(external.zmq.ZMQ.ZMQ_HELLO_MSG, helloMsg);
        }
        ...
        public int bindToRandomPort(String addr, int min, int max)
        {
            ...
            for (int i = 0; i < 100; i++) { // hardcoded to 100 tries. should this be parametrised
                port = external.zmq.util.Utils.randomInt(max - min + 1) + min;
        ...
        {
            return send(data.getBytes(CHARSET), external.zmq.ZMQ.ZMQ_SNDMORE);
        }
        ...
        {
            return send(data, external.zmq.ZMQ.ZMQ_SNDMORE);
        }
        ...
        {
            external.zmq.Msg msg = new external.zmq.Msg(data);
        ...
        public boolean send(byte[] data, int off, int length, int flags)
        {
            ...
            external.zmq.Msg msg = new external.zmq.Msg(copy);
            if (base.send(msg, flags)) {
                return true;
            }
        ...
        {
            external.zmq.Msg msg = base.recv(flags, cancellationToken.canceled);
        ...
        protected void mayRaise()
        {
            ...
            if (errno != 0 && errno != external.zmq.ZError.EAGAIN) {
    ...
    public static class Poller implements Closeable
    {
         ...
         */
        public static final int POLLIN  = external.zmq.ZMQ.ZMQ_POLLIN;
        /**
         ...
         */
        public static final int POLLOUT = external.zmq.ZMQ.ZMQ_POLLOUT;
        /**
         ...
         */
        public static final int POLLERR = external.zmq.ZMQ.ZMQ_POLLERR;
        ...
        public int poll(long tout)
        {
            ...
            external.zmq.poll.PollItem[] pollItems = new external.zmq.poll.PollItem[items.size()];
            ...
            try {
                return external.zmq.ZMQ.poll(selector, pollItems, items.size(), tout);
            }
    ...
    {
        private final external.zmq.poll.PollItem base;
        private final Socket            socket;

        public PollItem(Socket socket, int ops)
        {
            this.socket = socket;
            base = new external.zmq.poll.PollItem(socket.base, ops);
        }

        public PollItem(SelectableChannel channel, int ops)
        {
            base = new external.zmq.poll.PollItem(channel, ops);
            socket = null;
        }

        final external.zmq.poll.PollItem base()
        {
            return base;
        }
    ...
    public static class Event
    {
        ...
        {
            external.zmq.ZMQ.Event e = external.zmq.ZMQ.Event.read(socket.base, flags);
            Object resolvedValue;
            switch (e.event) {
            case external.zmq.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_PROTOCOL:
                resolvedValue = ZMonitor.ProtocolCode.findByCode((Integer) e.arg);
                break;
            case external.zmq.ZMQ.ZMQ_EVENT_CLOSE_FAILED:
            case external.zmq.ZMQ.ZMQ_EVENT_ACCEPT_FAILED:
            case external.zmq.ZMQ.ZMQ_EVENT_BIND_FAILED:
            case external.zmq.ZMQ.ZMQ_EVENT_HANDSHAKE_FAILED_NO_DETAIL:
                resolvedValue = Error.findByCode((Integer) e.arg);
                break;
            case external.zmq.ZMQ.ZMQ_EVENT_CONNECTED:
            case external.zmq.ZMQ.ZMQ_EVENT_LISTENING:
            case external.zmq.ZMQ.ZMQ_EVENT_ACCEPTED:
            case external.zmq.ZMQ.ZMQ_EVENT_CLOSED:
            case external.zmq.ZMQ.ZMQ_EVENT_DISCONNECTED:
                resolvedValue = e.getChannel(socket.base);
                break;
            case external.zmq.ZMQ.ZMQ_EVENT_CONNECT_DELAYED:
            case external.zmq.ZMQ.ZMQ_EVENT_HANDSHAKE_SUCCEEDED:
                resolvedValue = null;
                break;
            default:
                resolvedValue = e.arg;
    ...
    public static class Curve
    {
        ...
        {
            String[] keys = new external.zmq.io.mechanism.curve.Curve().keypairZ85();
        ...
        {
            return external.zmq.io.mechanism.curve.Curve.z85EncodePublic(key);
        }
